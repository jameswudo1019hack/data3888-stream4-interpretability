"""Extract per-class .zip files into a flat per-class folder layout, filtering
the spurious *_10.png files (Ed #254). Idempotent — already-extracted files
are skipped, so it's safe to re-run as new zips arrive.

Usage:
  python unzip_all.py                               # default: ./Images/  -> ./data/100/
  python unzip_all.py --size 50                     # default 50 paths: ./Images_50/ -> ./data/50/
  python unzip_all.py --src my_zips --dst my_data   # custom paths
"""
import argparse
import sys
